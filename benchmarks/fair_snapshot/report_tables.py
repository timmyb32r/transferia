...
labels={'rust':'Transferia Rust Auto','rust_ranges':'Transferia Rust exact PK¹','go':'Transferia Go · typed path','seatunnel':'SeaTunnel','sling':'Sling²','datax':'DataX · default polling','airbyte':'Airbyte connectors³','flink':'Flink CDC','debezium':'Debezium + Kafka + JDBC','debezium_bulk':'Debezium bulk-tuned⁴','inlong':'InLong Sort','meltano':'Meltano²','spark':'Spark','sqoop':'Sqoop import + export','estuary':'Estuary local preview² ³'}
