...
/// `read_batch` converts every decoded item into a connector-neutral `Message` while the
...
fn required_topic_path<'a>(
    event: &str,
    partition: i64,
    topic: Option<&'a crate::connectors::logbroker::proto::pers_queue::v1::Path>,
) -> anyhow::Result<&'a str> {
    topic
...
fn validate_event_identity(
    event: &str,
    partition: i64,
    topic: Option<&crate::connectors::logbroker::proto::pers_queue::v1::Path>,
    cluster: &str,
