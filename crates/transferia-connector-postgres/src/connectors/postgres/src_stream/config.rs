...
pub struct PostgresReplicationConfig {
    ...
    #[schemars(
        ...
        description = "Maximum time in milliseconds for replication bootstrap, execution-lease operations, and slot acknowledgements; also bounds snapshot cancellation and cleanup in both snapshot modes",
