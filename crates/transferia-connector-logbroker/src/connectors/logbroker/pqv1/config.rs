...
impl PqV1SinkConfig {
    pub fn validate(&self) -> anyhow::Result<()> {
        crate::connectors::address::validate_host("pqv1.host", &self.host)?;
        crate::connectors::address::validate_port("pqv1.port", self.port)?;
    ...
    pub(crate) fn endpoint(&self) -> String {
        crate::connectors::address::url("grpc", &self.host, self.port)
    }
}
