...
use transferia_connector_logbroker::logbroker::proto::operations::{
...
",
    ...
    let connector = PqV1SourceConnector::from_config(config, Arc::new(MetricsRegistry::new()))?;
...
mod topic_settings {
    pub use transferia_connector_logbroker::logbroker::proto::pers_queue::v1::topic_settings::ReadRule;
}
