...
pub use crate::connectors::logbroker::transport::{connect_http2_prior_knowledge, H2Service};
use transferia_core::failure::DataPlaneFailure;
use transferia_delivery_contracts::retry::stable_retry_seed;
...
async fn discover_proxies(
    ...
    timeout: core::time::Duration,
    cancellation: &CancellationToken,
) -> anyhow::Result<Vec<crate::connectors::logbroker::proto::discovery::EndpointInfo>> {
    use crate::connectors::logbroker::proto::discovery::{
        ListEndpointsRequest, ListEndpointsResult,
    };
    use crate::connectors::logbroker::proto::operations::GetOperationResponse;
...
pub(super) fn decode_describe_topic_response(
    response: crate::connectors::logbroker::proto::pers_queue::v1::DescribeTopicResponse,
) -> anyhow::Result<crate::connectors::logbroker::proto::pers_queue::v1::TopicSettings> {
    use crate::connectors::logbroker::proto::pers_queue::v1::DescribeTopicResult;
    use prost::Message as _;
...
pub(super) fn describe_topic_request(
    topic_path: &str,
) -> crate::connectors::logbroker::proto::pers_queue::v1::DescribeTopicRequest {
    use crate::connectors::logbroker::proto::operations::{
...
impl PqV1Client {
    pub async fn discover_endpoints(
        ...
        String,
        Vec<crate::connectors::logbroker::proto::discovery::EndpointInfo>,
    )> {
