...
fn protocol_path(path: &str) -> crate::connectors::logbroker::proto::pers_queue::v1::Path {
    crate::connectors::logbroker::proto::pers_queue::v1::Path {
        path: path.to_string(),
    }
}
...
fn describe_topic_response(
    settings: Option<crate::connectors::logbroker::proto::pers_queue::v1::TopicSettings>,
    status: i32,
) -> crate::connectors::logbroker::proto::pers_queue::v1::DescribeTopicResponse {
    use prost::Message as _;

    let result = crate::connectors::logbroker::proto::pers_queue::v1::DescribeTopicResult {
        self_: None,
        settings,
    };
    crate::connectors::logbroker::proto::pers_queue::v1::DescribeTopicResponse {
        operation: Some(crate::connectors::logbroker::proto::operations::Operation {
            ready: true,
            status,
...
fn describe_topic_decodes_successful_metadata() {
    let settings = crate::connectors::logbroker::proto::pers_queue::v1::TopicSettings {
        partitions_count: 3,
        ..Default::default()
    };
    let decoded =
...
fn describe_topic_requests_synchronous_metadata() {
    ...
    assert_eq!(
        ...
        crate::connectors::logbroker::proto::operations::operation_params::OperationMode::Sync
            as i32
    );
}
...
fn describe_topic_requires_a_ready_sync_operation() {
    let mut response = describe_topic_response(
        Some(crate::connectors::logbroker::proto::pers_queue::v1::TopicSettings::default()),
        YDB_STATUS_SUCCESS,
    );
...
fn successful_status_with_issues_is_terminal() {
    let message = MigrationStreamingReadServerMessage {
        status: YDB_STATUS_SUCCESS,
        issues: vec![crate::connectors::logbroker::proto::issue::IssueMessage {
